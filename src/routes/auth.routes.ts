import { GetProfileRouteSchema, LoginRouteSchema, RegisterRouteSchema } from '@/schemas';
...
export async function authRoutes(app: FastifyInstance) {
  ...
  app.get('/auth/profile', { schema: GetProfileRouteSchema, onRequest: [authGuard] }, getProfile);
}
