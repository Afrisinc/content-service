...
export async function getAllGeneratedPosts(
  ...
  return ApiResponseHelper.success(
    reply,
    'Generated posts fetched successfully',
    response,
 ...
 */
export async function getGeneratedPostsByStatus(
  request: FastifyRequest,
  reply: FastifyReply
): Promise<void> {
  ...
  const { posts, total } = await n8nGeneratedPostRepository.findByStatus(
    params.status,
    page,
    limit
  );
...
export async function getGeneratedPostById(
  ...
  return ApiResponseHelper.success(
    reply,
    'Generated post fetched successfully',
    post,
    ResponseCode.SUCCESS,
    200
  );
...
export async function createGeneratedPost(
  ...
  return ApiResponseHelper.success(
    reply,
    'Generated post created successfully',
    post,
    ResponseCode.SUCCESS,
    201
  );
...
export async function updateGeneratedPost(
  ...
  return ApiResponseHelper.success(
    reply,
    'Generated post updated successfully',
    post,
    ResponseCode.SUCCESS,
    200
  );
...
export async function deleteGeneratedPost(
  ...
  return ApiResponseHelper.success(
    reply,
    'Generated post deleted successfully',
    post,
    ResponseCode.SUCCESS,
    200
  );
 ...
 */
export async function getGeneratedPostsByPlatform(
  request: FastifyRequest,
  reply: FastifyReply
): Promise<void> {
  ...
  const { posts, total } = await n8nGeneratedPostRepository.findByPlatform(
    params.platform,
    page,
    limit
  );
